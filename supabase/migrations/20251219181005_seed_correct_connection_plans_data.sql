/*
  # Seed Connection Plans Data - Correct Data

  ## Overview
  Seeds the CORRECT 4 connection plans with 18 actions.

  ## Plans:
    1. New Lead Follow-Up Plan (5 actions)
    2. Lost Opportunity Re-engagement (4 actions)
    3. Post-Meeting Follow-Up (3 actions)
    4. Customer Onboarding (6 actions)
*/

-- Insert connection plans
