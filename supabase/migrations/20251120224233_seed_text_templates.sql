/*
  # Seed Text Templates Data

  1. Purpose
    - Populate the templates table with sample text/SMS templates
    - Provide realistic examples matching the reference design

  2. Data Inserted
    - 15 text templates with varying contact types
    - Templates include SMS messages for appointments, confirmations, and general communication
    - All templates have appropriate TCPA classifications

  3. Fields Populated
    - name: Template name
    - contact_type: Target audience (All, Clients, etc.)
    - content: SMS message content
    - category: Set to 'text' for all records
    - content_tcpa: TCPA classification (Promotional/Transactional)
