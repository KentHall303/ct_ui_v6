/*
  # Seed Export List Templates Data

  1. Purpose
    - Populate the templates table with export list templates
    - Provide examples for various data export scenarios
    - Support CSV/Excel export functionality with custom field configurations

  2. Data Inserted
    - 8 export list templates for different export scenarios
    - Templates covering contacts, projects, financial data, and reports
    - Various field configurations and filtering options

  3. Fields Populated
    - name: Template name
    - description: Detailed description of export purpose
    - content: JSON configuration of export fields and settings
    - category: Set to 'export_list' for all records
    - variables: Export configuration including fields, filters, and format
    - is_active: All set to true
    - usage_count: Initialized to 0
*/

-- Insert comprehensive export list templates
