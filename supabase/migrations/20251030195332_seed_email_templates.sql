/*
  ...
  ## Overview
  This migration adds 10 email template records for testing and demonstration purposes.

  ## Sample Data
    - Creates 10 email templates alternating between two types:
      1. Missing data notification templates
